...
Solenoid m_solenoid1 = new Solenoid(PneumaticsModuleType.REVPH, 0);
Solenoid m_solenoid2= new Solenoid(PneumaticsModuleType.REVPH, 1);
...
// DoubleSolenoid m_solenoid = pneumaticHub.makeDoubleSolenoid(1,2);
  ...
  public void autonomousPeriodic() {
    ...
    //     m_solenoidArm2.set(true); 
    //  }
    //  else if (time1.get() >= 1 && time1.get() < 1)  {
     
    //    m_armleft.set(-.3);
    //   m_armright.set( -.3);
    
    //  }  else if (time1.get() >= 1.6 && time1.get() < 2)  {
    //   m_leftFlywheel.set(-.75);
    //   m_rightFlywheel.set(-.75);
       
    
    //   }  else if (time1.get() >= 2.2 && time1.get() < 2.4)  {
    //   m_intake.set(.5);
       
    
    //  }
    //      else if (time1.get() >= 2.4 && time1.get() < 2.5)  {
    //   m_intake.set(0);
    //     m_leftFlywheel.set(0);
    //   m_rightFlywheel.set(0);
    
    //  }
    //  else if (time1.get() >= 2.5 && time1.get() < 5)  {
    //   m_intake.set(-.5);
  ...
  public void teleopPeriodic() {
    ...
    if (driver.getRawAxis(PS4Controller.Axis.kL2.value) > .1) {
      m_intake.set(driver.getRawAxis(PS4Controller.Axis.kL2.value) * .5);
    } else if (driver.getRawAxis(PS4Controller.Axis.kR2.value) > .1) {
      m_intake.set(-driver.getRawAxis(PS4Controller.Axis.kR2.value) * .5);
    } else {
      m_intake.stopMotor();
    }
    if (m_operator.getRawAxis(XboxController.Axis.kLeftTrigger.value) > .1) {
      intakePivot.set(driver.getRawAxis(XboxController.Axis.kLeftTrigger.value) * .3);
    } else if (m_operator.getRawAxis(XboxController.Axis.kRightTrigger.value) > .1) {
      intakePivot.set(-driver.getRawAxis(XboxController.Axis.kRightTrigger.value) * .3);
    } else {
